...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/js/all.min.js"
    integrity="sha512-rpLlll167/T5LJHwp0waJCh3ZRf7pO6IT1+LZOhAyP6phAirwchClbTZV3iqL3BMrVxIYRbzGTpli4rfxsCK6Vw=="
...
<body>
  ...
  <div class="row">
  <div class="col-sm my-4 m-4" >
  <h4>Car Owner SignIn</h4>
  
  <form action="CarOwnerLogin" method="post">
             
             <input class="form-control m-2" type="email" name="email" placeholder="Your email" required />
              
              
                <input class="form-control m-2" type="password" name="password" 
  ...
  <form action="RegisterCarOwner" method="post" enctype="multipart/form-Data">
           <div>
            <input class="form-control m-2" type="email" name="email" placeholder="Your email" required />
              ...
              <div >
                <input class="form-control m-2" type="text" name="name" pattern="[a-zA-Z]+" maxlength="25"
                  placeholder="Your name" required />
              </div>
              
              <div >
                <input class="form-control m-2" type="tel" name="phone" pattern="[0-9]+" maxlength="10"
                  placeholder="Your Tel." required />
              </div>
              
              <div >
                <textarea rows="3" class="form-control m-2"  name="address" maxlength="100" placeholder="Your Address"
                   required ></textarea>
              </div>
              
              <div >
                <label>Your ID Proof(eg:Aadhar/PanCard/DL/VoterCard)</label>
              
                <input class="form-control m-2" type="file" name="idproof" 
                  placeholder="Your name" required />
              </div>
